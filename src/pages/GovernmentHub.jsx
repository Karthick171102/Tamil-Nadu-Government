...
import { 
  Search, ArrowRight, X, Users, Building2, MapPin, ShieldCheck, Phone
} from 'lucide-react';
...
const GovernmentHub = () => {
  ...
  const categories = [
    { label: t('gov.cat.ministers'), icon: Users, desc: t('gov.cat.ministersDesc'), color: '#005600' },
    { label: t('gov.cat.departments'), icon: Building2, desc: t('gov.cat.departmentsDesc'), color: '#005600' },
    { label: t('gov.cat.districts'), icon: MapPin, desc: t('gov.cat.districtsDesc'), color: '#005600' },
    { label: t('gov.cat.agencies'), icon: ShieldCheck, desc: t('gov.cat.agenciesDesc'), color: '#005600' },
    { label: t('services.cat.contactDirectory'), icon: Phone, desc: t('services.cat.contactDirectoryDesc'), color: '#005600' },
  ];
