...
const ServicesHub = () => {
  ...
  const categories = [
    ...
    { label: t('services.cat.grievances'), icon: MessageSquare, desc: t('services.cat.grievancesDesc'), image: 'https://images.unsplash.com/photo-1600880292203-757bb62b4baf?auto=format&fit=crop&w=600&q=80', color: '#005600', path: '/services/grievances' },
